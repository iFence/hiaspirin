<script lang="ts">
  ...
  /**
   * A small decorative snail that slowly crawls back and forth along the very
   * top edge of the printer shell.
   *
   ...
   * the body (foot + shell) stays put and only the head + eye-stalks sweep
    ...
    >
      ...
      <g class="snail-head" bind:this={head}>
        ...
        <g class="snail-stalk snail-stalk-back">
          ...
          <circle class="snail-eye-pupil" cx="27" cy="10.1" r="1.05" />
        </g>
        <g class="snail-stalk snail-stalk-front">
          ...
          <circle class="snail-eye-pupil" cx="34.4" cy="8.4" r="1.2" />
        </g>
      </g>

      <!-- Shell — completely static, drawn last so it sits over the head -->
      <g class="snail-shell">
        <circle class="snail-shell-disc" cx="30" cy="19" r="12" />
        <path
          class="snail-shell-spiral"
          fill="none"
        ...
        />
        <ellipse class="snail-shell-shine" cx="25" cy="13.5" rx="3" ry="2" />
      </g>
    </svg>
  </div>
</div>
